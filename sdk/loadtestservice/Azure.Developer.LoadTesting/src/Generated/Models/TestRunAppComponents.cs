...
namespace AzureLoadTesting.Models
{
    ...
    public partial class TestRunAppComponents
    {
        ...
        internal TestRunAppComponents(IReadOnlyDictionary<string, AppComponent> components, string testRunId, DateTimeOffset? createdDateTime, string createdBy, DateTimeOffset? lastModifiedDateTime, string lastModifiedBy)
        {
            Components = components;
            TestRunId = testRunId;
